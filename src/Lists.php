...
class Lists extends Endpoint
{
     ...
     * @return array
     */
    public function all(?int $count, ?int $page, ?bool $advertised)
    {
        $options = [];
     ...
     * @throws \Exception
     */
    public function members(string $name, ?int $count, ?int $page)
    {
     ...
     * @throws \Exception
     */
    public function create(string $name, ?string $style)
    {
        $this->validateEmail($name);
